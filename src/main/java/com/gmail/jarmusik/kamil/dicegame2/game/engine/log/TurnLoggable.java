...
public interface TurnLoggable {
    void startTurnLog(GamePlayer player, ResultsGame resultsGame) throws PlayerHasNotBeenAddedToGameException;
    void turnLog(int numberOfRollCurrent, int pointsRoll, GameFlow master);
    void endTurnLog(GamePlayer player, ResultsGame resultsGame) throws PlayerHasNotBeenAddedToGameException;
}
